...
dataset, using code. In a previous large-scale workplace project, these tasks were conducted by a statistician due to the scale and complexity of the dataset. This project replicates that workflow on a smaller, simulated dataset, enabling practical learning with respect to database design and conducting statistical analysis through Python. 
